...
- Filter Type
    ...
    - Default, Low Pass
- Band Number (option available for Octave filter types)
...
- Prototype Parameters
    ...
    - Default, 6
- Passband Ripple (option available for Chebyshev prototype)
    - Maximum ripple loss in passband
    - Default, 0.010 dB
- Stopband Ripple (option available for Inverse Chebyshev prototype)
